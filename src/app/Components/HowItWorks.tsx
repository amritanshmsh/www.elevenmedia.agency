    ...
    <section id="howitworks" className="bg-gradient-to-br from-gray-50 via-white to-purple-50 py-24 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-purple-300 via-purple-500 to-purple-700 rounded-full"></div>
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className={`w-7/12 ${index % 2 === 0 ? 'pr-8' : 'pl-8'}`}>
                  <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 hover:border-purple-200 hover:shadow-2xl transition-all duration-300 group relative overflow-hidden">
                    ...
                    {/* Decorative element in unused space */}
                    <div className={`absolute ${index % 2 === 0 ? '-left-4' : '-right-4'} top-4 w-2 h-16 bg-gradient-to-b from-purple-400 to-purple-600 rounded-full opacity-20`}></div>
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-purple-700 font-semibold mb-4 text-lg leading-relaxed">
                        {step.description}
                      </p>
                ...
                <div className="relative z-10 w-8 h-8 bg-gradient-to-br from-purple-500 to-purple-700 rounded-full border-4 border-white shadow-lg flex items-center justify-center mt-6">
                  <div className="w-3 h-3 bg-white rounded-full"></div>
                </div>

                {/* Numbers and Expected Outcome on opposite side */}
                <div className={`w-5/12 ${index % 2 === 0 ? 'pl-8' : 'pr-8'} flex flex-col items-center justify-start mt-6`}>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="bg-gradient-to-br from-purple-100 via-purple-50 to-white rounded-2xl p-10 border border-purple-200 shadow-xl">
            ...
            <a
              href="/contactform"
              className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white bg-gradient-to-r from-purple-600 to-purple-700 rounded-xl hover:from-purple-700 hover:to-purple-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              Get Started Today →
            </a>
          </div>
